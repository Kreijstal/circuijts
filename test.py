...
Nmos M1        ; The NMOS transistor

; --- Connections ---
; Define how M1's terminals are connected to abstract circuit nodes.
; These nodes (node_gate, node_drain, node_source, node_bulk)
; would be where external stimuli are applied or measurements taken
; in a larger simulation or test setup.

M1 { G:(node_gate), D:(node_drain), S:(node_source), B:(node_bulk) }
"""
